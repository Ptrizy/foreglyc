...
class MonitoringSettingsInfoScreen extends StatefulWidget {
  final String wakeUpStartTime;
  final String wakeUpEndTime;
  final String sleepStartTime;
  final String sleepEndTime;
  final List<String> physicalActivityDays;
  const MonitoringSettingsInfoScreen({
    super.key,
    required this.wakeUpStartTime,
    required this.wakeUpEndTime,
...
class _MonitoringSettingsInfoScreenState
  ...
  void _submitForm() {
    ...
    print('Wake Up Time: ${widget.wakeUpStartTime} - ${widget.wakeUpEndTime}');
    print('Sleep Time: ${widget.sleepStartTime} - ${widget.sleepEndTime}');
    print('Activity Days: ${widget.physicalActivityDays}');
    ...
    context.read<MonitoringPreferenceBloc>().add(
      CreateGlucometerPreferenceEvent(
        startWakeUpTime: widget.wakeUpStartTime,
        endWakeUpTime: widget.wakeUpEndTime,
        physicalActivityDays: widget.physicalActivityDays,
        startSleepTime: widget.sleepStartTime,
        endSleepTime: widget.sleepEndTime,
